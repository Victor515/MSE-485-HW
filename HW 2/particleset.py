...
class ParticleSet(object): # use the new-style class

    """ The ParticleSet class is designed to hold the position, velocity and accelerations of a set of particles. The self._pos, self._vel, self._accel variables
        are NOT meant to be accessed or modified directly. Please use accessor and modifier methods instead. 
...
if __name__ == '__main__':
    ...
    pset.init_vel(temperature,mass)
    vel = pset.all_vel()
